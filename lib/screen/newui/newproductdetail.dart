    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, AsyncSnapshot<ProductModel> snapshot) {
          return snapshot.hasData ? Stack(children: [
                  ...
                  ClipRRect(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          margin:
                              EdgeInsets.only(top: 230, left: 20, right: 20),
                                ...
                                Container(
                                  ...
                                  child: SmoothStarRating(
                                    ...
                                    rating: double.parse(snapshot
                                        .data.data.productRating.avgRating),
                                        ...
                                        child: DropdownButtonHideUnderline(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: DropdownButton<String>(
                                              ...
                                              onChanged: (value) {
                                                option = snapshot.data.data
                                                    .productOptions[0].options
                                                    .where((element) {
                                                  return element.optionValueId
                                                      .contains(value);
                                                }).toList();
                                                setState(() {
                        ...
                        Container(
                            ...
                            margin:
                                EdgeInsets.only(left: 8, right: 8, bottom: 50),
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (_, index) {
                                          return Container(
                                            ...
                                            width: snapshot.data.data.images
                                                        .indexOf(e) ==
                                                    index
                                                ? 24
                                                : 12,
                                            decoration: BoxDecoration(
                                                color: snapshot.data.data.images
                                                            .indexOf(e) ==
                                                        index
                  ...
                  child: Row(
                    ...
                    children: [
                      TextButton(
                          onPressed: () async {
                            if (option != null) {
                              int i = await DatabaseHelper.instance.addtoCart({
                                ...
                                DatabaseHelper.optionname:
                                    snapshot.data.data.productOptions[0].name,
                                DatabaseHelper.optionvalueid:
                                    option[0].optionValueId,
                                DatabaseHelper.optionlable: option[0].label,
                                DatabaseHelper.productpriceincreased:
                                    option[0].increaseProductPriceBy,
                                DatabaseHelper.quantity: itemcount.toString(),
                                DatabaseHelper.price:
                                    (double.parse(snapshot.data.data.price) +
