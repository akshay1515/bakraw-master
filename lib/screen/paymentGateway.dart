...
//       for (int i = 0; i < rowlist.length; i++) {
//         valuelist.add(Values(
//             optionValueId: int.parse(rowlist[i].optionvalueId),
//             increaseProductPriceBy: rowlist[i].productpriceincreased));
//       }
//
//       for (int i = 0; i < rowlist.length; i++) {
//         List<Values> vList = [];
//         vList.add(valuelist[i]);
//         print('vlist ${vList[index].optionValueId}');
//         optionlist.add(ProductOptions(
//             optionId: int.parse(rowlist[i].optionid),
//             optionName: rowlist[i].optionname,
//             optionLabel: rowlist[i].optionlable,
//             values: vList));
//         vList.clear();
//         Provider.of<ProductProvider>(context, listen: false)
...
//
//     for (int i = 0; i < rowlist.length; i++) {
//       List<ProductOptions> olist = [];
//       olist.add(optionlist[i]);
//
...
//                 .toString(),
//             productOptions: olist));
//       } else {
//         list.add(OrderProducts(
//             productId: rowlist[i].productid,
//             productName: target[i].name,
//             isProductIsInSale: target[i].isProductIsInSale,
//             qty: rowlist[i].quantity,
//             unitPrice: rowlist[i].price,
